        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
                ...
                <div class="hidden lg:flex lg:gap-x-8">
                    <a href="/" class="text-sm/6 font-semibold text-white p-2 hover:bg-gray-400/50 transition-all duration-300 rounded-md">Home </a>
                    <a href="/about.php" class="text-sm/6 font-semibold text-white p-2 hover:bg-gray-400/50 transition-all duration-300 rounded-md">About Us</a>
                    <a href="/contact.php" class="text-sm/6 font-semibold text-white bg-gray-800 p-2 transition-all duration-300 rounded-md">Contact Us</a>
                </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Want to Contact Us ?</h1>
